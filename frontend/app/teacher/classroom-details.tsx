...
export default function TeacherClassroomDetailsScreen() {
...
const styles = StyleSheet.create({
  ...
  studentAvatarText: { fontSize: 16, fontWeight: "700", color: "#0369a1" },
  studentName: { fontSize: 15, fontWeight: "600", color: "#111827" },
  studentPhone: { fontSize: 13, color: "#6b7280" },
  removeBtn: { backgroundColor: "#fef2f2", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6, borderWidth: 1, borderColor: "#fecaca" },
  ...
  searchBtn: { backgroundColor: "#2563eb", paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8, justifyContent: "center" },
  searchBtnText: { color: "#fff", fontWeight: "600" },
  searchResults: { marginBottom: 12 },
  searchResultsLabel: { fontSize: 13, fontWeight: "600", color: "#374151", marginBottom: 8 },
  searchResultItem: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  searchResultPhone: { fontSize: 12, color: "#6b7280" },
  addResultBtn: { backgroundColor: "#2563eb", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
  ...
  closeModalBtn: { marginTop: 16, paddingVertical: 12, borderRadius: 8, backgroundColor: "#f3f4f6", alignItems: "center", borderWidth: 1, borderColor: "#d1d5db" },
